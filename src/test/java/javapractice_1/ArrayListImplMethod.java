...
public class ArrayListImplMethod {
	...
	//Method 12 - Sublist, First index inclusive and last index exclusive
		List A = P.subList(2, 6);
		for (Object o : A) {
			System.out.println(o);
		}System.out.println("-----------------------------------");
	...
	// Method 15 - Sort
		P.sort(((o1,o2)-> -1)); //if there is positive no then it will sort in ascending and negative will decending
		I= P.iterator();
		while (I.hasNext()) {
			System.out.println(I.next());
		}System.out.println("-----------------------------------");
		
	// Method 16 - Collectioln sort
		Collections.sort(P);
